...
int main()
{
    ...
    int employee; //Employee or nah
    
    // Set the desired output formatting for numbers.
    cout << setprecision(2) << fixed << showpoint;
    
    //Prompt if user is employee or customer
    cout << "Please enter 0 for customer usage and 1 for employee usage: ";
    cin >> employee;
    
    // Prompt the user for the crate's length, width, and height
    if(employee == 0){
        cout << "Welcome to our store, valued guest!" << endl;
    }
    if(employee == 1){
        cout << "Welcome back, employee access granted."<< endl;
    }
